...
# 
# Note: this is unpinned because replit doesn't allow for enough storage to handle pinned versions
# 
{ pkgs ? import <nixpkgs> {} }:  
pkgs.mkShell {
    ...
    buildInputs = [
        ...
        # 
        pkgs.unixtools.arp         # depends on openssl_1_0_2     
        pkgs.unixtools.ifconfig    # depends on openssl_1_0_2         
        pkgs.unixtools.netstat     # depends on openssl_1_0_2         
        pkgs.unixtools.ping        # depends on openssl_1_0_2     
        pkgs.unixtools.route       # depends on openssl_1_0_2         
        pkgs.unixtools.col
    ...
    shellHook = ''
        ...
        # exports
        # 
        export NIX_CC_PATH="${pkgs.stdenv.cc.cc.lib}"
